...
def createScene(rootNode, policySeed = 0):
    ...
    if recordCenterline: 
        rootNode.addObject(centerlineStateExporterMulti(filetype=0, name='centerlineExporter', segments = [segment0, segment1,segment2], policySeed =policySeed))
    if recordFullState: 
        rootNode.addObject(fullStateExporterMulti(filetype=0, name='stateExporter', segments = [segment0, segment1,segment2], policySeed =policySeed))
