...
filenamePrefix = "centerlineExporter_policySeed_0_step_" 
filenameSuffix = ".npy"

# Filepaths for input data
filepath_inputs = config["currentDirectory"] +"data/inputData/" 
filenamePrefix_inputs = "inputExporter_policySeed_0_step_" 
...
animation.write_gif(savePath + "20231103.gif",fps=fps)
