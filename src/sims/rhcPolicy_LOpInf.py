...
class rhcPolicy_LOpInf(): 
    def __init__(self,dt,T=50, *args, **kwargs):
        ...
        for t in range(T):
            ...
            cost += 0.5*cp.sum_squares(self.y[7:11:2,t+1]-self.y_ref[7:11:2,t+1])
            cost += 0.2*cp.sum_squares(self.y[11:15:2,t+1]-self.y_ref[11:15:2,t+1])
            cost += 0.1*cp.sum_squares(self.y[15:25:2,t+1]-self.y_ref[15:25:2,t+1])
            cost += 0.05*cp.sum_squares(self.y[25:39:2,t+1]-self.y_ref[25:39:2,t+1])
            ...
            cost+= 2100*cp.sum_squares(self.du[:, t])
